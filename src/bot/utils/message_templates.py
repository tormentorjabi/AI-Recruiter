...
VIEW_VACANCY_PARAMS = "🔍 Просмотреть параметры опросника"
EDIT_VACANCY_PARAMS = "⚙️ Редактировать параметры опросника"
VIEW_RESUME_SCREENING_PARAMS = "📝 Просмотреть параметры скрининга резюме"
EDIT_RESUME_SCREENING_PARAMS = "⚙️ Редактировать параметры скрининга резюме"
