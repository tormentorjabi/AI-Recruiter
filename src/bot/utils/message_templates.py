...
DEMO_HELPER = (
    "👋 *Уважаемые эксперты!*\n\n"
    "Вы можете протестировать работу с анкетой кандидата, с помощью заранее заготовленных резюме:\n"
    "`/send Оператор контактного центра https://nizhny-tagil.hh.ru/resume/7826507bff0ee34bf60039ed1f426e5833656c`\n"
    "`/send Оператор контактного центра https://nizhny-tagil.hh.ru/resume/a64fb867ff0ee350280039ed1f61396637496d`\n"
    "`/send Оператор контактного центра https://nizhny-tagil.hh.ru/resume/0d6c9f8fff0ee350ba0039ed1f764b3639577a`\n\n"
    "Выполните одну из команд выше, начните работу как кандидат командой */start*, и отправьте полученный токен!\n\n"
    "⚠️ *Если другой эксперт уже использовал одно из резюме, попробуйте выбрать следующее из списка, либо отправьте свое (резюме должно быть открыто для других)*"
)
